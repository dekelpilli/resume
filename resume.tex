...
\item {\sl Proficient Programming Languages:} Java (especially with Spring), Python.
\item {\sl Other Languages Used:} C, C\#, AngularJS \& NodeJS, Perl, PHP, Java for Android, Terraform.
\item {\sl Technologies Used:} MySQL/MS SQL Server, AWS (DynamoDB, S3, SQS, EC2), git \& SVN. 
