...
\item Actively challenged myself to work with our various DevOps tools, including CI (Jenkins and Spinnaker) and Infrastructure as Code (Terraform). %TODO ansible
