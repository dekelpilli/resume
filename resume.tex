...
\item \textbf{Other Languages Used:} C, C\#, AngularJS, Perl, PHP.
% Terraform
\item \textbf{Technologies Used:} MySQL/MS SQL Server, Liquibase, AWS (DynamoDB, S3, SQS, EC2, Cloudwatch), Redis, git \& SVN, Spring, Jenkins, Spinnaker, Maven, Tomcat. 
% Apache Camel
